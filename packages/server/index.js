...
app.post('/send-notification', async (req, res) => {
    ...
    const htmlContent = `
        ...
        <p><a href="https://10.150.92.15:3000/packages/user/tracker.html" style="font-size: 16px; padding: 12px 20px; background-color: #990909; color: white; text-decoration: none; border-radius: 5px;">Share Location</a></p>
